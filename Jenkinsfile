            ...
            steps {
                script {
                    dir(env.PROJECT_DIR) {
                        ...
                        // Crear .env.prod con los secretos de Jenkins para producción
                        if (env.ENVIRONMENT == 'production') {
                            sh """
                                echo "Creating .env.prod with Jenkins credentials..."
                                cat > .env.prod << 'ENVEOF'
# Environment variables for production - Generated by Jenkins
...
ENVEOF
                                echo "✅ Created .env.prod at \$(pwd)/.env.prod"
                                ls -la .env.prod
                            """
                        }
